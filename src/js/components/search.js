...
Search.prototype.init = function() {
    ...
    var featuresNeeded = 'querySelector' in document && 'addEventListener' in window && !!(Array.prototype && Array.prototype.forEach);
    ...
    accessibleAutocomplete({
        ...
        displayMenu: 'overlay',
        placeholder: 'Search Plastic Free Community',
        confirmOnBlur: false,
        autoselect: true,
